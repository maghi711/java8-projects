...
public class ExistingDefinition extends Entity {
	private static final Logger logger = Logger.getLogger(ExistingDefinition.class.getName());
	...
	private Map<String, RatingDefinition> ratingDefinitionMap = new HashMap<>();
...
/*	@JsonProperty
	...
	@JsonProperty
	public Map<String, RatingDefinition> getRatingDefinitionMap() {
		return ratingDefinitionMap;
	}

	@JsonProperty
	public void setRatingDefinitionMap(Map<String, RatingDefinition> ratingDefinitionMap) {
