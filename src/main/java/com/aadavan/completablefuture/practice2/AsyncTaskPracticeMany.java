...
public class AsyncTaskPracticeMany {
    static {
        BasicConfigurator.configure();
    }

    private static final Logger LOGGER = LoggerFactory.getLogger(AsyncTaskPracticeMany.class);

    public static void main(String[] args) throws ExecutionException, InterruptedException {
        LOGGER.info("Execution started...");

        List<P2Shop> shops = Arrays.asList(
                new P2Shop(),
                new P2Shop(),
                new P2Shop(),
                new P2Shop(),
